...
var ScoreUI = function(place, size, current) {
    ...
    document.getElementById(new_place).querySelector(".value").value = pad(this.current, this.size);


    document.getElementById(new_place).querySelector(".up").onclick = function() {
        this.current = scoreCounter.up();
        document.getElementById(new_place).querySelector(".value").value = this.current;
    };
